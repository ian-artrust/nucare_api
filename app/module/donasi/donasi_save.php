...
if(!$_SESSION){
	...
	*/
    ...
    $no_donasi	    = autonum(6,date('y')."DNS-".$kode_daerah, $kode_daerah);
    ...
    $pesan_sms = "Terima kasih Bp/Ibu ".$muzaki." telah melakukan ".$program." DilazisNU ".$daerah." Sebesar: ".number_format($jml_donasi, 0, ',', '.')." semoga dibalas oleh Alloh SWT";
    ...
    if($cekDonasi > 0 ){
        ...
        if($no_hp==''){
            ...
            $pesan 		= "Data Berhasil Disimpan | Konfirmasi Ke Bagian Keuangan Untuk Mengecek Rekening";
